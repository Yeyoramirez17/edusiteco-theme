                ...
                <article class="bg-white dark:bg-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up animation-delay-100 border border-gray-200 dark:border-gray-600">
                    <div class="p-6">
                        <div class="flex flex-col items-center text-center">
                            <div class="w-24 h-24 bg-blue-600 dark:bg-blue-500 rounded-full flex items-center justify-center text-white text-xl font-bold mb-4 transition-colors duration-300 group-hover:bg-accent">
                                MR
                            </div>
                            <header class="mb-4">
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2 font-plus-jakarta">María Rodríguez</h3>
                                <p class="text-blue-600 dark:text-blue-400 font-semibold font-plus-jakarta">Rectora</p>
                            </header>
                            <div class="mb-6">
                            ...
                            <footer class="flex space-x-4">
                                <a href="mailto:m.rodriguez@colegio.edu.co" class="contacto-btn w-10 h-10 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-700" aria-label="Enviar correo a María Rodríguez">
                    ...
                    <div class="p-6">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <header class="mb-4">
                                ...
                                <p class="text-blue-600 dark:text-blue-400 font-semibold font-plus-jakarta">Coordinador Académico</p>
                            </header>
                            <div class="mb-6">
                                <p class="text-gray-600 dark:text-gray-300 leading-relaxed font-plus-jakarta">
                ...
                <article class="bg-white dark:bg-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 animate-fade-in-up animation-delay-300 border border-gray-200 dark:border-gray-600">
                    <div class="p-6">
                        <div class="flex flex-col items-center text-center">
                            ...
                            <header class="mb-4">
                                <h3 class="text-xl font-bold text-gray-900 dark:text-white mb-2 font-plus-jakarta">Ana Pérez</h3>
                                <p class="text-blue-600 dark:text-blue-400 font-semibold font-plus-jakarta">Coordinadora de Convivencia</p>
                            </header>
                            <div class="mb-6">
                                <p class="text-gray-600 dark:text-gray-300 leading-relaxed font-plus-jakarta">
                            ...
                            <footer class="flex space-x-4">
                                <a href="mailto:a.perez@colegio.edu.co" class="contacto-btn w-10 h-10 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-700" aria-label="Enviar correo a Ana Pérez">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                        <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                    </svg>
                                </a>
                                <a href="tel:+573001234569" class="contacto-btn w-10 h-10 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 hover:bg-blue-600 dark:hover:bg-blue-500 hover:text-white transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 dark:focus:ring-offset-gray-700" aria-label="Llamar a Ana Pérez">
                                    <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                        <path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" />
                                    </svg>
                                </a>
    ...
    <section class="coordinaciones-section bg-gray-50 dark:bg-gray-800 py-16 px-4 transition-colors duration-300" aria-labelledby="coordinaciones-title">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <article class="bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border-t-4 border-blue-600 dark:border-blue-500 hover:border-accent animate-fade-in-up animation-delay-100">
                    <div class="p-6 text-center">
                        <div class="w-14 h-14 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 mb-4 mx-auto transition-all duration-300 group-hover:bg-blue-600 dark:group-hover:bg-blue-500 group-hover:text-white group-hover:rotate-12">
                        ...
                        <a href="mailto:academico@colegio.edu.co" class="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300 font-plus-jakarta focus:outline-none focus:underline">
                ...
                <article class="bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border-t-4 border-blue-600 dark:border-blue-500 hover:border-accent animate-fade-in-up animation-delay-200">
                    <div class="p-6 text-center">
                        <div class="w-14 h-14 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 mb-4 mx-auto transition-all duration-300 group-hover:bg-blue-600 dark:group-hover:bg-blue-500 group-hover:text-white group-hover:rotate-12">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="mailto:bienestar@colegio.edu.co" class="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300 font-plus-jakarta focus:outline-none focus:underline">
                ...
                <article class="bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border-t-4 border-blue-600 dark:border-blue-500 hover:border-accent animate-fade-in-up animation-delay-300">
                    <div class="p-6 text-center">
                        <div class="w-14 h-14 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 mb-4 mx-auto transition-all duration-300 group-hover:bg-blue-600 dark:group-hover:bg-blue-500 group-hover:text-white group-hover:rotate-12">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="mailto:sistemas@colegio.edu.co" class="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300 font-plus-jakarta focus:outline-none focus:underline">
                ...
                <article class="bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 border-t-4 border-blue-600 dark:border-blue-500 hover:border-accent animate-fade-in-up animation-delay-400">
                    <div class="p-6 text-center">
                        <div class="w-14 h-14 bg-gray-100 dark:bg-gray-600 rounded-full flex items-center justify-center text-blue-600 dark:text-blue-400 mb-4 mx-auto transition-all duration-300 group-hover:bg-blue-600 dark:group-hover:bg-blue-500 group-hover:text-white group-hover:rotate-12">
                            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                        ...
                        <a href="mailto:biblioteca@colegio.edu.co" class="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300 font-plus-jakarta focus:outline-none focus:underline">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
                ...
                <article class="bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 animate-fade-in-up animation-delay-100">
                    <div class="p-6 text-center">
                        ...
                        <a href="mailto:info@colegio.edu.co" class="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300 font-plus-jakarta focus:outline-none focus:underline">
                            info@colegio.edu.co
                        </a>
                    </div>
                </article>
                ...
                <article class="bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 animate-fade-in-up animation-delay-200">
                    <div class="p-6 text-center">
                        ...
                        <a href="tel:+5712345678" class="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300 font-plus-jakarta focus:outline-none focus:underline">
                            +57 (1) 234 5678
                        </a>
                    </div>
                </article>
                ...
                <article class="bg-white dark:bg-gray-700 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1 animate-fade-in-up animation-delay-300">
                    <div class="p-6 text-center">
                        ...
                        <a href="https://maps.google.com/?q=colegio+colombia+bogota" target="_blank" rel="noopener noreferrer" class="text-blue-600 dark:text-blue-400 font-medium hover:text-blue-800 dark:hover:text-blue-300 transition-colors duration-300 font-plus-jakarta focus:outline-none focus:underline">
